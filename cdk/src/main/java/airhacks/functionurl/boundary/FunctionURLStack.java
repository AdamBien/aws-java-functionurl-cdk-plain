...
public class FunctionURLStack extends Stack {
    ...
    public static class Builder {
        ...
        String functionName = "airhacks_HttpListener";
        String functionHandler = "airhacks.lambda.greetings.boundary.HttpListener::onHTTPRequest";
        ...
        public Builder(Construct construct, String stackNamePrefix) {
            ...
            this.stackId = stackNamePrefix.toLowerCase() + "-function-url-pojo-stack";
        }
    ...
    public FunctionURLStack(Builder builder) {
        super(builder.construct, "function-url-stack");
        var quarkusLambda = new POJOLambda(this, builder.functionName);
